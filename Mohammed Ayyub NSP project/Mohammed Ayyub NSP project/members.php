...
if (isset($_REQUEST["submit"])) {
    ...
    $ins = "INSERT INTO member (name,pass) VALUES ('$name','$pass')";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="admin-login.php"><img src="download-film3 (1).jpg" alt="Piyush Pawan Logo"></a>
...
<form>
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="pass" class="form-control" id="inputPassword4" placeholder="password">
    </div>
  </div>
